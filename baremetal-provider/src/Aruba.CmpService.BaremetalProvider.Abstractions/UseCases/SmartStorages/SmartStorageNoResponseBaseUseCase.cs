...
public abstract class SmartStorageNoResponseBaseUseCase<TRequest, TResponse> : NoResponseBaseUseCase<TRequest, TResponse>
    where TRequest : BaseUseCaseRequest
    where TResponse : EmptyMessageBusResponse
{
    protected ISmartStoragesService SmartStoragesService { get; }

    protected SmartStorageNoResponseBaseUseCase(ISmartStoragesService smartStoragesService)
    {
        SmartStoragesService = smartStoragesService;
    }
